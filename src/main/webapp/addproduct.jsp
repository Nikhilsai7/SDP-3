...
<form class="form-horizontal" method="post" action="/addproduct" modelAttribute="p" enctype="multipart/form-data">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="available_quantity" name="category" placeholder="Category" class="form-control input-md" required="" type="text">
  </div>
</div>
